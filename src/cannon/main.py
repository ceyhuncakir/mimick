...
def benchmark(
    ...
    """Run Cannon against the XBOW benchmark suite.
    ...
    Examples:
        ...
        cannon benchmark /path/to/validation-benchmarks --tags sqli,xss --level 1

        cannon benchmark /path/to/validation-benchmarks -f XBEN-001-24,XBEN-005-24

        cannon benchmark /path/to/validation-benchmarks -c 3 -i 20
    """
    from cannon.benchmark.runner import (
        discover_benchmarks,
        filter_benchmarks,
        print_summary,
        run_benchmarks,
