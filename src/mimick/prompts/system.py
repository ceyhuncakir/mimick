...
SYSTEM_PROMPT = """\
You are Mimick, an autonomous web application bug bounty hunter. You find \
...
Mimick automatically validates your findings after the assessment by replaying the \
